...
<div class="content">
    ...
    <div class="well">
        <!-- edit form -->
        <form action="/index.php/Admin/Manager/edit/id/24" method="post" id="tab">
            <label>用户名：</label>
            <input type="hidden" name="id" value="<?php echo ($manager["id"]); ?>"></input>
            <input type="text" name="username" value="<?php echo ($managerInfo["username"]); ?>" class="input-xlarge">
            <label>昵称：</label>
            <input type="text" name="nickname" value="<?php echo ($managerInfo["nickname"]); ?>" class="input-xlarge">
            <label>邮箱：</label>
            <input type="text" name="email" value="<?php echo ($managerInfo["email"]); ?>" class="input-xlarge">
